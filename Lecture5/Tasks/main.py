...
from bucket.crud import create_bucket, delete_bucket, bucket_exists, configure_static_website_hosting
...
def main():
    ...
    match args.command:
        ...
        case "object":
            ...
            if args.host_website:
                ''' use : python main.py object "bucketname" --host_website to call hosting website'''
                print(upload_local_file(s3_client, args.bucket_name, "index.html", args.keep_file_name, "upload_file"))
                print(upload_local_file(s3_client, args.bucket_name, "error.html", args.keep_file_name, "upload_file"))
                assign_policy(s3_client, "public_read_policy", args.bucket_name)
                print(configure_static_website_hosting(s3_client, args.bucket_name))
