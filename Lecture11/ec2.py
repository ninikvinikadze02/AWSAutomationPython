...
def run_ec2(ec2_client, sg_id, subnet_id, ec2_instance_name):
...
""",
  ...
  tag = {'Key': 'Name', 'Value': ec2_instance_name}
...
def create_security_group(ec2_client, security_group_name, description, VPC_ID):
